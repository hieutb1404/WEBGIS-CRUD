    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <?php 
                ...
                echo form_open_multipart('diem/add');
            ?>

            <div class="form-group">
                <label>Tên điểm</label>
                <input name="tendiem" placeholder="Tên Điểm" type="text" class="form-control"/>
            </div>

            <div class="form-group">
                <label>Loại</label>
                <input name="loai" placeholder="Loại" type="text" class="form-control"/>
            </div>


            <div class="form-group">
                <label>Vị trí</label>
                <input name="vitri" placeholder="Vị trí" type="text" class="form-control"/>
            </div>


            <div class="form-group">
                <label>Chữ lượng</label>
                <input name="chuluong" placeholder="Chữ lượng" type="text" class="form-control"/>
            </div>

            <div class="form-group">
                <label>Thời gian</label>
                <input name="thoigian" placeholder="Thời gian" type="text" class="form-control"/>
            </div>
            ...
            <div class="form-group">
                <label>Kinh độ</label>
                <input id="kinhdo" name="kinhdo" placeholder="Kinh độ" type="text" class="form-control"required/>
            </div>

            <div class="form-group">
                <label>Vĩ độ</label>
                <input id="vido" name="vido" placeholder="Vĩ độ" type="text" class="form-control"required/>
            </div>
