    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <?php 
                ...
                echo form_open_multipart('duong/edit/' . $duong->id_duong);
            ?>

            <div class="form-group">
                <label>Tên đường</label>
                <input name="tenduong" placeholder="Tên Đường" value=<?= $duong->tenduong ?> type="text" class="form-control"/>
            </div>

            <div class="form-group">
                <label>GeoJSON</label>
                <textarea name="geojson" rows="4" class="form-control"><?= $duong->geojson ?></textarea>
            </div>


            <div class="form-group">
                <label>Kiểu đường</label>
                <input name="kieuduong" placeholder="Kiểu đường" value=<?= $duong->kieuduong ?> type="text" class="form-control"/>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group my-colorpicker2">
                    <input name="color" value=<?= $duong->color ?> type="text" class="form-control"/>
            ...
            <div class="form-group">
                ...
                <img  src="<?= base_url('assets/hinhanh/' . $duong->hinhanh) ?>" width="120px"/>
            </div>
...
var drawnItems = new L.geoJSON(<?= $duong->geojson ?>);
