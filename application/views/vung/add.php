    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <?php 
                ...
                echo form_open_multipart('vung/add');
            ?>

            <div class="form-group">
                <label>Tên vùng</label>
                <input name="tenvung" placeholder="Tên Vùng" type="text" class="form-control"/>
            </div>
            <div class="form-group">
                <label>Tên tỉnh</label>
                <input name="tentinh" placeholder="Tên Tỉnh" type="text" class="form-control"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input name="donvihanhchinh" placeholder="Đơn Vị Hành Chính" type="text" class="form-control"/>
            </div>

            <div class="form-group">
                <label>Diện tích</label>
                <input name="dientich" placeholder="Diện Tích" type="text" class="form-control"/>
            </div>
